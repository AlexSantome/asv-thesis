...
\begin{itemize}
    ...
    \item \textbf{Stage 2: Integrated Body and Access Optimization:} Leveraging the experience and results from the first stage, the optimization was extended to include both the MMI body and the access tapers. Based on the convergence study in Stage 1, this final refinement was performed exclusively using the optimal etch-depth configuration and high-resolution settings to achieve the physical limit of the device performance.
\end{itemize}
