...
\title{Addressing the Scalability of Programmable Photonic Processors: From Architecture to 
...
\Author{Alejandro Santomé Valverde}{Faculty of Telecommunications Engineering}

\Degree{Doctor of Philosophy}{Faculty of Telecommunications Engineering}
\Supervisor{Dr. Daniel Pérez-López}{Chief Technology Officer of iPronics}
\Supervisor{Prof. Dr. Dr. José Capmany-Francoy}{Professor of Telecommunications Engineering}

% Professor who formally accepts theses for your department (e.g., the Graduate Officer, Professor Sméagol,...)
% If more than one department, use more than once
\Acceptor{To Be Defined}{Professor of Telecommunications Engineering}{}%{Undergraduate Officer, Department of Physics}
