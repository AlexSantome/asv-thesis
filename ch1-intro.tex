...
\begin{itemize}
	...
	\item \textbf{Chapter 3: Silicon Photonic Building Blocks} focuses on the hardware layer. It 
	details the design, simulation, and optimization of the fundamental components, including 
	Multi-mode Interference (MMI) couplers and high-efficiency phase shifters (thermo-optic and 
	plasma-dispersion based), establishing the building blocks for the subsequent mesh integration.
    
    \item \textbf{Chapter 4: Mesh Architectures and System-Level Challenges} addresses the 
	transition from individual cells to large-scale systems. It explores different network 
	topologies (Reck, Clements) and the synthesis algorithms required for their configuration. 
	Furthermore, it analyzes the impact of fabrication tolerances and describes state-of-the-art 
	calibration and fault-tolerance techniques to ensure reliable operation.

    \item \textbf{Chapter 5: Applications and Experimental Validation} demonstrates the practical 
    ...
    \item \textbf{Chapter 6: Conclusions and Future Work} summarizes the main contributions of this 
